...
def create_app():
    ...
    CORS(app, resources={r"/*": {"origins": ["https://villa-bnb-drop.onrender.com", "http://localhost:3000","http://localhost:3001"], "methods": ["GET", "POST", "DELETE", "OPTIONS"], "supports_credentials": True}})
